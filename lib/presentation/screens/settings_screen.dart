...
class SettingsScreen extends StatelessWidget {
            ...
            child: ConstrainedBox(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _buildSectionHeader(
                    context,
                    AppLocalization.get('language', appLanguage),
                  ),
                  ...
                  _buildSectionHeader(
                    context,
                    AppLocalization.get('appearance', appLanguage),
                  ),
                  ...
                  _buildSectionHeader(
                    context,
                    AppLocalization.get('font_settings', appLanguage),
                  ),
                  ...
                  _buildSliderTile(
                    ...
                    onChanged: (v) => context
                        .read<SettingsCubit>()
                        .setArabicFontSize(v.roundToDouble()),
                  ),
                  const Gap(8),
                  _buildSliderTile(
                    context,
                    ...
                    onChanged: (v) => context
                        .read<SettingsCubit>()
                        .setTranslationFontSize(v.roundToDouble()),
                  ),
                  const Gap(8),
                  ...
                  _buildSectionHeader(
                    context,
                    AppLocalization.get('reading_behavior', appLanguage),
                  ),
                  _buildToggleTile(
                    context,
                    ...
                    onChanged: (v) =>
                        context.read<SettingsCubit>().setWakeLockEnabled(v),
                  ),
                  _buildToggleTile(
                    context,
                    ...
                    onChanged: (v) =>
                        context.read<SettingsCubit>().setAutoMarkRead(v),
                  ),
                  if (state.autoMarkRead)
                    _buildSliderTile(
                      ...
                      subtitle: AppLocalization.get(
                        'dwell_timer_seconds',
                        appLanguage,
                        args: {'seconds': state.dwellTimerSeconds.toString()},
                      ),
                  ...
                  _buildSectionHeader(
                    context,
                    AppLocalization.get('about_section', appLanguage),
                  ),
                  _buildInfoTile(
                    context,
          ...
          Row(
            children: [
              ...
              _buildThemeOption(
                ...
                onTap: () =>
                    context.read<SettingsCubit>().setThemeMode('system'),
              ),
            ],
          ),
        ],
          ...
          Wrap(
            ...
            children: arabicFonts.map((font) {
              ...
              return ChoiceChip(
                ...
                onSelected: (_) {
                  context.read<SettingsCubit>().setArabicFontFamily(
                    font['key']!,
                  );
                },
              );
  ...
  Widget _buildArabicPreview(BuildContext context, SettingsState state) {
    ...
    final isLocalFont =
        state.arabicFontFamily == 'Me Quran' ||
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (preview != null) ...[const Gap(4), preview],
        ],
      ),
    ).animate().fadeIn(duration: 350.ms).slideY(begin: 0.05, end: 0);
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text(trailing, style: TextStyle(color: textSecondary, fontSize: 12)),
        ],
      ),
    ).animate().fadeIn(duration: 350.ms).slideY(begin: 0.05, end: 0);
  }
